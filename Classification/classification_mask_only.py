...
class MaskOnlyDataset(Dataset):
    ...
    def _read_mask(self, path):
        ...
        # =============================================
        # BLANK MASK IF EMPTY PATH
        # =============================================

        if path == "" or pd.isna(path):
        ...
        # =============================================
        # IF FILE MISSING → BLANK MASK
        # =============================================

        if mask is None:

            print(f"[WARN] Missing mask: {path}")
...
def make_resnet18_1ch(num_classes):
...
def main():
    ...
    model = make_resnet18_1ch(num_classes)
    ...
    plt.title("Mask-Only Test Confusion Matrix")

    plt.tight_layout()

    plt.savefig("mask_only_test_confusion_matrix.png")

    print("\nSaved: mask_only_test_confusion_matrix.png")
